export const ENGINE_VERSION = "ict-decision-engine-v2.1.0";
export const PARAMETER_SET_VERSION = "model-1-score-based-2026-08-23";
...
export const DEFAULT_PARAMETERS = Object.freeze({
  ...
  risk: { minimumRR: 1.2, stopBufferAtr: 0.08, maximumStopAtr: 3.2, noChaseRewardR: 0.55 },
  score: {
    htfContext: 15,
    location: 10,
    liquidity: 5,
